...
Day 2: Implemented Merge sort and Inversion counting(number of pairs required to switch places to create a sorted array). These simple algorithms demonstrate the power of divide and conquer quite well. Both runs in O(nlogn) time compare to O(n^2) of the brute force approach.
