...
int ToInt(const char& value) { return value - '0'; }

void MakeEqualLength(std::string& lhs, std::string& rhs)
{
...
std::string KaratsubaMultiplication_Internal(std::string& lhs, std::string& rhs)
{
    MakeEqualLength(lhs, rhs);
...
std::string KaratsubaMultiplication(std::string& lhs, std::string& rhs)
{
...
int main()
{
    ...
    std::cout << "Answer : " + KaratsubaMultiplication(lhs, rhs) + "\n\n";
